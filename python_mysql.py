...
class Connection(object)
    ...
    The main value we provide is wrapping rows in a dictobject so that
    ...
    def __init__(self, host, database, user=None, password=None)
        ...
        args = dict(conv=CONVERSIONS, use_unicode=True, charset=utf8,
                    db=database, init_command='SET time_zone = +800',
...
# Fix the access conversions to properly recognize unicodebinary
